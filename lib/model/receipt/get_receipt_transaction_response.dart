class GetReceiptTransactionResponse {
  String universalId;
  String receiptId;
  String bankDetailId;
  ...
  factory GetReceiptTransactionResponse.fromJson(Map<String, dynamic> json) => GetReceiptTransactionResponse(

class GetEstimatesResponse {
  ...
  factory GetEstimatesResponse.fromJson(Map<String, dynamic> json) =>
      GetEstimatesResponse(
        ...
        estimateDetails: List<EstimateDetail>.from(
            json["estimateDetails"].map((x) => EstimateDetail.fromJson(x))),
        estimateNotes: List<EstimateNote>.from(

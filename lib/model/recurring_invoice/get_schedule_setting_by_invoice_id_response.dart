class GetScheduleSettingByInvoiceIdResponse {
  String universalId;
  String invoiceNo;
  int totalAmount;
  bool isActive;
  ...
  GetScheduleSettingByInvoiceIdResponse({
  ...
  factory GetScheduleSettingByInvoiceIdResponse.fromJson(Map<String, dynamic> json) => GetScheduleSettingByInvoiceIdResponse(

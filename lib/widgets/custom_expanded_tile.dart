...
/// See also:
///
///  * [CustomExpandedTile], which is the widget this object controls.
///
///
/// {@tool snippet}
///
...
class CustomExpandedTileController extends ChangeNotifier {
  ...
  /// Getter for the current expansion state of the [CustomExpandedTile] widget.
  bool get isExpanded => _isExpanded;
  set _setExpanded(bool ex) {
    _isExpanded = ex;
  }

  CustomExpandedTileController copyWith({
    bool? isExpanded,
  }) {
    return CustomExpandedTileController(
  ...
  /// VoidCallback that expands the [CustomExpandedTile] widget if it is collapsed.
  void expand() {
    _setExpanded = true;
    notifyListeners();
  }

  /// VoidCallback that collapses the [CustomExpandedTile] widget if it is expanded.
  void collapse() {
    _setExpanded = false;
    notifyListeners();
  }

  /// VoidCallback that toggles the expansion state of the [CustomExpandedTile] widget.
  void toggle() {
    isExpanded ? collapse() : expand();
  }
}

/// Theming data for the [CustomExpandedTile] widget, Mostly Colors & Spacing.
///
/// {@tool snippet}
///
/// ```dart
...
////? Misc
  ...
  /// Returns a new [CustomExpandedTile] widget with the same arguments unless stated otherwise.
  ///
  ///
...
typedef ExpandedTileBuilder = CustomExpandedTile Function(

...
import 'package:diy_boox/widgets/invoicing/send_reminder_dialog.dart';
...
class InvoiceSchedule extends StatefulWidget {
  const InvoiceSchedule({super.key});

  @override
  State<InvoiceSchedule> createState() => _InvoiceScheduleState();
}

class _InvoiceScheduleState extends State<InvoiceSchedule> {
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              SvgPicture.asset('assets/invoices/send.svg'),
                              SizedBox(
                                width: 5,
                              ),
                              Text(
